...
class ControllerShippingjne extends Controller {
	...
	public function index() {   
		...
		if (isset($this->request->post['jne_cost'])) {
			$this->data['jne_cost'] = $this->request->post['jne_cost'];
		} else {
			$this->data['jne_cost'] = $this->config->get('jne_cost');
		}
		...
		if (isset($this->request->post['jne_geo_zone_id'])) {
			$this->data['jne_geo_zone_id'] = $this->request->post['jne_geo_zone_id'];
		} else {
			$this->data['jne_geo_zone_id'] = $this->config->get('jne_geo_zone_id');
		}
